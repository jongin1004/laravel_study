            ...
            <div class="grid mt-3 mb-10">
                <div class="mt-8">
                    <div class="mt-2">
                        ...
                        <label><input type="checkbox" class="mt-3" name="agree1" value="agree1" @if(old('agree1')) checked @endif>同意します。</label>
                        @error('agree1')
            ...
            <div class="grid mt-3 mb-10">
                <div class="mt-8">
                    <div class="mt-2">
                        ...
                        <label><input type="checkbox" class="mt-3" name="agree2" value="agree2" @if(old('agree2')) checked @endif>同意します。</label>
                        @error('agree2')
                            <small class="text-red-500">{{ $message }}</small><br>
                        @enderror
                    </div>
