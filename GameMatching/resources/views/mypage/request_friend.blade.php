        ...
        <div class="border p-4">                 
            ...
            <div class="text-right mt-2">
                ...
                <form method="POST" name="form">
                    ...
                    <input class="bg-blue-700 hover:bg-gray-900 text-white font-bold py-2 px-4 border border-gray-900 rounded" 
                    type="submit" value="수락" onclick="javascript: form.action='/friend/accept';"/>
                    <input class="bg-red-700 hover:bg-gray-900 text-white font-bold py-2 px-4 border border-gray-900 rounded" 
